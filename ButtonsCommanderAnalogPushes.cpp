...
ButtonsCommanderAnalogPushes::ButtonsCommanderAnalogPushes(byte inNumberOfItems) : ButtonsCommanderButton()
{
	this->analogPin = 0;
...
bool ButtonsCommanderAnalogPushes::Loop()
{
	this->UnselectLastLoop();
	for (int i = 0; i < this->size; i++)
		this->pButtons[i].UnselectLastLoop();
